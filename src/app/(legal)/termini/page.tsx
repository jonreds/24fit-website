...
export const metadata = {
  title: "Termini e Condizioni | 24FIT",
  description: "Condizioni generali di abbonamento e regolamento 24FIT",
};
...
export default function TerminiPage() {
  return (
    <LegalPageLayout title="Condizioni Generali di Abbonamento e Regolamento">
      ...
      <div className="mb-6">
        <h2 className="text-base font-semibold mb-2 text-gray-900">1. Iscrizione</h2>
        <p className="text-gray-700 mb-3 font-medium leading-relaxed">
          L'iscrizione alla palestra è soggetta ai termini ed alle condizioni del presente contratto.
        </p>
        <p className="text-gray-700 mb-3 font-medium leading-relaxed">
        ...
        <p className="text-gray-700 mb-3 font-medium leading-relaxed">
          La Società si riserva il diritto di respingere, a proprio insindacabile giudizio, le richieste di iscrizione
          non ritenute idonee.
        </p>
        <p className="text-gray-700 mb-3 font-medium leading-relaxed">
          L'iscritto si impegna a corrispondere per intero la quota di iscrizione stabilita dal contratto, secondo le
          modalità ivi indicate, anche nel caso in cui dovesse assentarsi o interrompere momentaneamente la frequenza
          della palestra per qualsiasi motivo non dipendente dalla Società.
        </p>
        <p className="text-gray-700 mb-3 font-medium leading-relaxed">
          La Società si riserva di non rimborsare la quota versata anche nelle ipotesi, a titolo esemplificativo e non
      ...
      <div className="mb-6">
        <h2 className="text-base font-semibold mb-2 text-gray-900">4. Condizioni fisiche del Cliente</h2>
        <p className="text-gray-700 mb-3 font-medium leading-relaxed">
        ...
        <p className="text-gray-700 mb-3 font-medium leading-relaxed">
          Il cliente si impegna a non utilizzare nessuna struttura della palestra durante il periodo in cui la sua
          condizione di salute possa comportare rischi per la salute di altri clienti.
        </p>
      </div>
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-700 mb-3 font-medium leading-relaxed">
          ...
          di Gestione ma oggettive, il contratto rimane sospeso sino alla ripresa della attività. Nel merito si applicano i
          contenuti dell'articolo 1256 c.c. per cui l'impossibilità temporanea, finché detta impossibilità perdura, esclude
          la responsabilità della società di gestione per il ritardo dell'adempimento. La società di gestione, cessata la
          suddetta impossibilità, deve sempre eseguire la prestazione, indipendentemente da un suo diverso interesse economico
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-700 mb-3 font-medium leading-relaxed">
          ...
          anni è consentito solo nel periodo compreso tra le ore 09:00 e le ore 20:00 e previa specifica autorizzazione
          rilasciata dal genitore del minore.
        </p>
        <p className="text-gray-700 mb-3 font-medium leading-relaxed">
          <strong>8.4</strong> - Le persone con disabilità, possono accedere alla palestra nel rispetto delle prescrizioni
          generali con l'unica limitazione che l'accesso può avvenire solo nelle fasce orarie in cui è presente personale
          al desk precisato per ogni struttura sia on line che on side.
        </p>
      </div>

      <div className="mb-6">
        <h2 className="text-base font-semibold mb-2 text-gray-900">9. Condotta</h2>
        <p className="text-gray-700 mb-3 font-medium leading-relaxed">
          I clienti e gli ospiti devono usare le strutture e le attrezzature in conformità con le indicazioni fornite dal
          personale della palestra e con le segnalazioni apposte a tale scopo.
        </p>
        <ul className="list-disc pl-6 mb-3 text-gray-700 font-medium space-y-1">
          <li>È obbligatorio lasciare libero l'armadietto dopo l'uso, in caso contrario la Direzione sarà costretta a rimuovere il lucchetto di chiusura.</li>
          <li>È vietato circolare nei locali della palestra con indumenti non rispettosi del decoro altrui.</li>
          <li>È obbligatorio il riconoscimento per l'accesso alla palestra attraverso sensore di prossimità o tessera magnetica.</li>
          <li>È assolutamente vietato fumare nei locali della palestra.</li>
          <li>È obbligatorio l'utilizzo della borraccia durante l'erogazione delle bevande.</li>
          <li>È necessario essere in possesso di scarpe di ricambio e asciugamano per l'allenamento e di un lucchetto per l'armadietto.</li>
        </ul>
      </div>
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-700 mb-3 font-medium leading-relaxed">
          ...
          effettuate riprese audio e video, in cui potrebbe rientrare ed acconsente ed autorizza l'uso, la pubblicazione,
          la distribuzione e la messa in commercio delle riprese video di tale materiale in ogni canale televisivo, on-line
          e in ogni supporto digitale presente e futuro.
        </p>
        <p className="text-gray-700 mb-3 font-medium leading-relaxed">
          In nessun caso il cliente potrà rivalersi sull'autore e/o su 24FIT SRL per il risarcimento di eventuali danni morali
          e materiali causati da soggetti terzi o derivati da utilizzi non previsti nella presente liberatoria.
        </p>
      </div>
      ...
      <div className="bg-[var(--brand)] p-6 rounded-xl">
        ...
        <p className="text-white font-medium">
          Per qualsiasi domanda relativa ai presenti termini e condizioni:<br />
